...
const Main = () => {
  ...
  useEffect(() => {
    const initialCardProps: CardProps[] = Array.from({ length: upgradeTarget }, () => ({
      essence: false,
      reol: false,
      dvigg: false,
    }));
  ...
  return (
    ...
    <div className="row d-flex">
      <div className="col-md-6 left-col" style={{ background: 'black', border: 'solid 1px black', boxShadow: '0 0 3px 1px black', maxHeight: '730px' }}>
      ...
      <div className="col d-flex flex-column justify-content-center align-items-center mid-col mx-4 my-5" style={{ maxHeight: '300px' }}>
        ...
        {displayStats && (
          <div className="m-5">
            ...
            <div className="main-theme-text mb-3">
              Lowest cost: {lowestPrice}
            </div>
            <div className="main-theme-text">
              Highest cost: {highestPrice}
            </div>
          </div>
        )}
      </div>
      ...
      <div className="col-md-6 d-flex flex-wrap right-col" style={{ alignContent: 'start' }}>
        {cardProps && cardProps.map((card, index) => (
          <div key={index} className="text-center my-2 mx-2 upgrade-card">
            <h1 className="main-theme-text">+{index}</h1>
